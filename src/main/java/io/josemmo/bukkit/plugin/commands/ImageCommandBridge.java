...
public class ImageCommandBridge {
    ...
    public static void register(@NotNull YamipaPlugin plugin) {
        ...
        for (String alias : COMMAND_ALIASES) {
            ...
            LiteralCommandNode<?> aliasNode = new LiteralCommandNode(alias, commandNode.getCommand(),
                    commandNode.getRequirement(), commandNode, commandNode.getRedirectModifier(), commandNode.isFork());
    ...
    private static @NotNull Command getRootCommand() {
        ...
        // Help command
        root.withPermission("yamipa.command.clear", "yamipa.clear", "yamipa.command.describe", "yamipa.describe",
                "yamipa.command.download", "yamipa.download", "yamipa.command.give", "yamipa.give",
                "yamipa.command.list", "yamipa.list", "yamipa.command.place", "yamipa.place",
                "yamipa.command.remove.own", "yamipa.remove", "yamipa.command.top", "yamipa.top")
        ...
        // Clear command
        root.addSubcommand("clear").withPermission("yamipa.command.clear", "yamipa.clear")
                .withArgument(new IntegerArgument("x")).withArgument(new IntegerArgument("z"))
                .withArgument(new WorldArgument("world")).withArgument(new IntegerArgument("radius", 1))
                .withArgument(new PlacedByArgument("placedBy")).executes((sender, args) ->
                {
        ...
        // Describe command
        root.addSubcommand("describe").withPermission("yamipa.command.describe", "yamipa.describe")
        ...
        // Download command
        root.addSubcommand("download").withPermission("yamipa.command.download", "yamipa.download")
                .withArgument(new StringArgument("url")).withArgument(new StringArgument("filename"))
                .executes((sender, args) ->
                {
        ...
        // Give subcommand
        root.addSubcommand("give").withPermission("yamipa.command.give", "yamipa.give")
                .withArgument(new OnlinePlayerArgument("player")).withArgument(new ImageFileArgument("filename"))
                ...
                .withArgument(new ImageFlagsArgument("flags", FakeImage.DEFAULT_GIVE_FLAGS)).executes((sender, args) ->
                {
        ...
        root.addSubcommand("give").withPermission("yamipa.command.give", "yamipa.give")
                ...
                .withArgument(new IntegerArgument("amount", 1, 64))
                .withArgument(new IntegerArgument("width", 1, FakeImage.MAX_DIMENSION))
                .withArgument(new IntegerArgument("height", 1, FakeImage.MAX_DIMENSION)).executes((sender, args) ->
                {
        ...
        root.addSubcommand("give").withPermission("yamipa.command.give", "yamipa.give")
                .withArgument(new OnlinePlayerArgument("player")).withArgument(new ImageFileArgument("filename"))
                .withArgument(new IntegerArgument("amount", 1, 64))
                .withArgument(new IntegerArgument("width", 1, FakeImage.MAX_DIMENSION)).executes((sender, args) ->
                {
        ...
        // List subcommand
        root.addSubcommand("list").withPermission("yamipa.command.list", "yamipa.list")
                .withArgument(new IntegerArgument("page", 1)).executes((sender, args) ->
                {

                    ImageCommand.listImages(sender, (int) args[1]);

                });
        root.addSubcommand("list").withPermission("yamipa.command.list", "yamipa.list").executes((sender, __) -> {
        ...
        // Place subcommand
        root.addSubcommand("place").withPermission("yamipa.command.place", "yamipa.place")
        ...
        root.addSubcommand("place").withPermission("yamipa.command.place", "yamipa.place")
                .withArgument(new ImageFileArgument("filename"))
                .withArgument(new IntegerArgument("width", 1, FakeImage.MAX_DIMENSION)).executesPlayer((player, args) ->
                {
        ...
        // Remove subcommand
        root.addSubcommand("remove").withPermission("yamipa.command.remove.own", "yamipa.remove")
                .executesPlayer((player, __) ->
                {
        ...
        // Top subcommand
        root.addSubcommand("top").withPermission("yamipa.command.top", "yamipa.top").executes((sender, __) -> {
