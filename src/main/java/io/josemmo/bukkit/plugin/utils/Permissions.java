...
public class Permissions {
    ...
    @Nullable
    private static TownyAPI townyApi = null;
    @Nullable
    private static LandsIntegration landsApi = null;
    ...
    public static boolean canBuild(@NotNull Player player, @NotNull Location location) {
        ...
        return queryWorldGuard(player, location, true) && queryGriefPrevention(player, location, true)
                && queryTowny(player, location, true) && queryLands(player, location, true);
    ...
    public static boolean canDestroy(@NotNull Player player, @NotNull Location location) {
        ...
        return queryWorldGuard(player, location, false) && queryGriefPrevention(player, location, false)
                && queryTowny(player, location, false) && queryLands(player, location, false);
    ...
    private static boolean queryGriefPrevention(@NotNull Player player, @NotNull Location location, boolean isBuild) {
        ...
        try {
            ...
            return Bukkit.isPrimaryThread() ? canEditCallable.call()
